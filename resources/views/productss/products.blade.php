...
<div class="row">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">اسم الالمنتج</th>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل الالمنتج</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="/products/update" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="recipient-name" class="col-form-label">اسم الالمنتج:</label>
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف الالمنتج</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
